      ...
      <div className="max-w-3xl mx-auto bg-white/5 p-8 rounded-xl shadow-lg backdrop-blur">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <p>
            ...
            <p><span className="text-[#38bdf8] font-semibold">AMOUNT:</span> 10,000 KES</p>
          </div>
...
// This code defines a React component for registering delegates for an event.
// It includes a form with fields for the delegate's name, institution, phone number, and transaction confirmation code.        